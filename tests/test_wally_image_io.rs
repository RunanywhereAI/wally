//! `io::image_io::write_png` failure paths.
//!
//! The rerank/rag `read_text_file` and DOCUMENT-preview behaviour is covered
...
/// An engine-supplied diagnostic_rgba buffer shorter than
...
/// Open-failure branch: writing to a path whose parent

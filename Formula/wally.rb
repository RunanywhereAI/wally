...
class Wally < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/RunanywhereAI/wally/releases/download/v0.5.7/wally-0.5.7-macos-arm64.tar.gz"
      # Placeholder -- the v0.5.7 release has not published a wally-named asset

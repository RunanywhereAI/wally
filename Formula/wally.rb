...
class Wally < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/RunanywhereAI/wally/releases/download/v0.7.0/wally-0.7.0-macos-arm64.tar.gz"
      # Placeholder -- the v0.7.0 release has not published a wally-named asset
